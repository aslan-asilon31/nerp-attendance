...
namespace App\Livewire\Pages\ProductContentResources\Components;
...
final class ProductContentTable extends PowerGridComponent
{
  ...
  public function fields(): PowerGridFields
  {
    return PowerGrid::fields()
      ->add('action', fn($record) => Blade::render('<a href="/product-contents/edit/' . e($record->id) . '"  :isEdit="true" >Edit</a>'))
      ->add('id')
      ->add('products_name')
      ->add('title')
      ->add('slug')
